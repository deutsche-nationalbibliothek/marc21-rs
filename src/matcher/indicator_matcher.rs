...
use crate::matcher::common::ws;
use crate::parse::ParseMatcherError;
...
impl IndicatorMatcher {
    /// Returns true if the the matcher matches against the given field.
    ///
    /// # Example
    ///
    /// ```rust
    ...
    pub fn is_match(&self, field: &Field) -> bool {
        match field {
            ...
            Field::Data(df) => match self {
                ...
                Self::None => {
                    df.indicator1 == b' ' && df.indicator2 == b' '
                }
                Self::Wildcard => true,
            },
        }
