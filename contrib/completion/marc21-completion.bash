_marc21() {
    ...
    do
        case "${cmd},${i}" in
            ",$1")
                cmd="marc21"
                ;;
            marc21,build-completions)
                cmd="marc21__build__completions"
                ;;
            marc21,build-man)
    ...
    case "${cmd}" in
        marc21)
            opts="-h -V --help --version concat cat count cnt filter hash invalid print sample split build-completions build-man"
